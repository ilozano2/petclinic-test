...
```
tanzu apps workload create spring-petclinic-2 -f config/workload.yaml \
  --local-path . \
  --source-image <REPOSITORY-PREFIX>/spring-petclinic-2-source \
  --type web
```
...
```
tanzu apps workload get spring-petclinic-2
```
